...
namespace LocationAlarm.Common
{
    ...
    /// <summary>
    /// SuspensionManager captures global session state to simplify process lifetime management for
    /// an application. Note that session state will be automatically cleared under a variety of
    ...
    internal sealed class SuspensionManager
    {
        ...
        /// <summary>
        /// List of custom types provided to the <see cref="DataContractSerializer"/> when reading
        /// and writing session state. Initially empty, additional types may be added to customize
        ...
        /// serializable by <see cref="DataContractSerializer"/> and should be as compact as
        ...
        /// registration if state has already been restored for the specified key the navigation
        /// history will immediately be restored. Subsequent invocations of
        ...
        /// An optional key that identifies the type of session. This can be used to distinguish
        /// between multiple application launch scenarios.
        /// </param>
        public static void RegisterFrame(Frame frame, String sessionStateKey, String sessionBaseKey = null)
        {
            ...
            // Use a dependency property to associate the session key with a frame, and keep a list
            // of frames whose navigation state should be managed
        ...
        /// state, which in turn gives their active <see cref="Page"/> an opportunity restore its state.
        /// </summary>
        /// <param name="sessionBaseKey">
        /// An optional key that identifies the type of session. This can be used to distinguish
        /// between multiple application launch scenarios.
        ...
        /// </summary>
        /// <remarks>
        /// Apps may choose to rely on <see cref="NavigationHelper"/> to manage page-specific state
        /// instead of working with frame session state directly.
        /// </remarks>
