...
namespace LocationAlarm.Common
{
    ...
    /// <see cref="RaiseCanExecuteChanged"/> needs to be called whenever <see cref="CanExecute"/> is
    /// expected to return a different value.
    /// </summary>
    public class RelayCommand : ICommand
    {
        ...
        /// return value of the <see cref="CanExecute"/> method has changed.
        /// </summary>
