...
namespace LocationAlarm.View
{
    ...
    /// </summary>
    public sealed partial class AlarmSettingsPage
    {
        private ObservableDictionary defaultViewModel = new ObservableDictionary();
        private NavigationHelper navigationHelper;

        /// <summary>
        /// Gets the view model for this <see cref="Page"/>. This can be changed to a strongly typed
        /// view model.
        /// </summary>
        ...
        /// <see cref="Frame.Navigate(Type, object)"/> when this page was initially requested and a
